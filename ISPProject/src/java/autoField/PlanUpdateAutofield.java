 ...
 * @author Harish
 */
public class PlanUpdateAutofield extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       PrintWriter out = response.getWriter();
        try  {
            ...
            ResultSet rs = stmt.executeQuery("select *  from planinfo where name='"+ a.trim()  +"' and loginid="+loginid+"  ");
            
            while (rs.next()) {
          
                obj.put("des", rs.getString(4));
